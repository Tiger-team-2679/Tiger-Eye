...
import org.team2679.TigerEye.core.TigerEyeProperties;
...
public class DriverStationCommunication {
    ...
    public static void broadcast() {
        String service = "roborio-" + TigerEyeProperties.SIM_TEAM + "-frc";
        String hostname = "roborio-" + TigerEyeProperties.SIM_TEAM + "-frc";
    ...
    public static void decodePacket(DatagramPacket packet, byte[] buffer) {
        ...
        if (buffer[2] != 0) {
            ...
            SimulationData.currentState = ctrl == 0 ? ROBOT_STATE.DISABLED :
                    ctrl == 4 ? ROBOT_STATE.TELEOP :
                            ctrl == 6 ? ROBOT_STATE.AUTONOMOUS :
                                    ctrl == 5 ? ROBOT_STATE.TEST :
                                            ROBOT_STATE.DISABLED;

            SimulationData.alliance_station = buffer[5];
            SimulationData.is_new_data_available = true;
